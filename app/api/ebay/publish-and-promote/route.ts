...
import { fetchAccountSetup, publishAndPromoteListing } from "@/lib/ebay/publish";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const result = await publishAndPromoteListing(accessToken, setup, body);
    ...
    console.error(`[ebay/publish-and-promote] unhandled error sku=${body.sku}:`, e);
    return NextResponse.json(
